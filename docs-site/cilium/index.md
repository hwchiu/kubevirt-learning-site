...
| eBPF Datapath | bpf_lxc.c、bpf_host.c、bpf_xdp.c 核心 eBPF 程式解析 |
| 身份與安全模型 | CiliumIdentity、安全標籤、mTLS 身份驗證機制 |

### 網路核心

| 文件 | 說明 |
|------|------|
| 網路模型 | VXLAN/Geneve Overlay、Native Routing、節點間路由 |
| 負載均衡 | kube-proxy 替代、Maglev 哈希、DSR 模式 |
