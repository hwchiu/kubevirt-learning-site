...
![指標收集流程 — metricsdocs 工具自動彙整 9 個子專案指標](/diagrams/monitoring/monitoring-metrics-collection.png)
...
![Recording Rule 命名驗證流程](/diagrams/monitoring/monitoring-recording-rule-validation.png)
...
![Runbook 下游同步流程](/diagrams/monitoring/monitoring-runbook-sync-sequence.png)
...
![GitHub Actions CI/CD 工作流程總覽](/diagrams/monitoring/monitoring-cicd-overview.png)
...
![每日自動化排程時序 (UTC)](/diagrams/monitoring/monitoring-daily-schedule.png)
...
![monitoringlinter 靜態分析規則檢查流程](/diagrams/monitoring/monitoring-linter-checks.png)
