...
![VM Launcher Pod 結構](/diagrams/kubevirt/kubevirt-aux-launcher-pod-structure.png)
...
![Container Disk 啟動流程](/diagrams/kubevirt/kubevirt-aux-container-disk-sequence.png)
...
![virt-launcher-monitor 監控架構](/diagrams/kubevirt/kubevirt-aux-launcher-monitor-flow.png)
...
![virt-freezer 檔案系統凍結流程](/diagrams/kubevirt/kubevirt-aux-freezer-sequence.png)
...
![VM Export Proxy 架構](/diagrams/kubevirt/kubevirt-aux-export-proxy-arch.png)
