...
![KubeVirt 升級策略總覽](/diagrams/kubevirt/kubevirt-upgrade-1.png)
...
![virt-operator 建立 InstallStrategy ConfigMap 的時序圖](/diagrams/kubevirt/kubevirt-upgrade-2.png)
...
![KubeVirt 升級狀態轉換圖](/diagrams/kubevirt/kubevirt-upgrade-3.png)
...
![WorkloadUpdateController 執行 LiveMigrate 的時序圖](/diagrams/kubevirt/kubevirt-upgrade-4.png)
...
![Evict 策略批次驅逐流程](/diagrams/kubevirt/kubevirt-upgrade-5.png)
...
![EvictionStrategy 決策流程](/diagrams/kubevirt/kubevirt-upgrade-7.png)
...
![升級故障排除決策樹](/diagrams/kubevirt/kubevirt-upgrade-6.png)
...
![CRD Storage Version 遷移流程](/diagrams/kubevirt/kubevirt-upgrade-8.png)
