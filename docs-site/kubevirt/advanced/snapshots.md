...
![Online Snapshot 流程](/diagrams/kubevirt/kubevirt-snapshot-online-notion.png)

### Offline Snapshot（離線快照）

離線快照在 VM 停止後建立，資料完全靜止，具有最高的一致性保證：

![Offline Snapshot 流程](/diagrams/kubevirt/kubevirt-snapshot-offline-notion.png)
...
![VirtualMachineSnapshot 資源關係](/diagrams/kubevirt/kubevirt-snapshot-structure-notion.png)
...
![建立快照完整流程](/diagrams/kubevirt/kubevirt-snapshot-flow-notion.png)
...
![VirtualMachineRestore 還原操作流程](/diagrams/kubevirt/kubevirt-snapshot-clone-2.png)
...
![VirtualMachineClone 流程](/diagrams/kubevirt/kubevirt-vmclone-sequence.png)
