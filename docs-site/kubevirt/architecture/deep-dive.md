...
![Admission Webhook 呼叫鏈](/diagrams/kubevirt/kubevirt-deep-dive-webhook-chain.png)
:::
...
![Volume 熱插拔運作流程](/diagrams/kubevirt/kubevirt-deep-dive-hotplug-flow.png)
...
![TLS 憑證體系結構](/diagrams/kubevirt/kubevirt-deep-dive-cert-hierarchy.png)
...
![KubeVirt 升級流程](/diagrams/kubevirt/kubevirt-deep-dive-upgrade-flow.png)
...
![Device Plugin 生命週期](/diagrams/kubevirt/kubevirt-deep-dive-device-plugin.png)
