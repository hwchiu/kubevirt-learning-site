...
![VirtualMachineInstanceMigration 狀態轉換](/diagrams/kubevirt/kubevirt-vmim-states.png)
...
![Migration 傳輸模式比較](/diagrams/kubevirt/kubevirt-vmim-sequence.png)
...
![VMI Live Migration 必要條件檢查](/diagrams/kubevirt/kubevirt-vmim-requirements.png)
...
![節點驅逐觸發 Live Migration 流程](/diagrams/kubevirt/kubevirt-node-drain-sequence.png)
...
![Migration 頻寬設定比較](/diagrams/kubevirt/kubevirt-migration-bandwidth.png)
