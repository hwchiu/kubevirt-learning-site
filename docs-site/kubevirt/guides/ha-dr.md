...
![節點失敗恢復流程](/diagrams/kubevirt/kubevirt-hadr-node-failure-flow.png)
...
![PDB 保護流程](/diagrams/kubevirt/kubevirt-hadr-pdb-flow.png)
...
![疏散流程](/diagrams/kubevirt/kubevirt-hadr-evacuation-flow.png)
...
![跨叢集 DR — Storage Replication + VM Manifest 備份](/diagrams/kubevirt/kubevirt-hadr-cross-cluster.png)
