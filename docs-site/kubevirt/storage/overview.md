...
![KubeVirt 儲存類型概覽](/diagrams/kubevirt/kubevirt-storage-overview-1.png)
...
![Volume 到 Disk 型別對應](/diagrams/kubevirt/kubevirt-storage-overview-2.png)
...
![磁碟 Bus 效能與相容性排序](/diagrams/kubevirt/kubevirt-storage-overview-3.png)
...
![磁碟 Cache 模式比較](/diagrams/kubevirt/kubevirt-storage-overview-4.png)
...
![IOThread 策略比較：shared vs auto](/diagrams/kubevirt/kubevirt-storage-overview-5.png)
...
![CDI 資料來源與 DataVolume](/diagrams/kubevirt/kubevirt-storage-overview-6.png)

### DataVolume 生命周期

![DataVolume 生命周期狀態機](/diagrams/kubevirt/kubevirt-storage-overview-7.png)
...
![磁碟線上擴展流程](/diagrams/kubevirt/kubevirt-storage-overview-8.png)
...
![儲存架構決策指南](/diagrams/kubevirt/kubevirt-storage-overview-9.png)
