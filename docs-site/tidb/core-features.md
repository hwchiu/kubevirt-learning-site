...
![TiDB SQL 解析與執行流程](/diagrams/tidb/tidb-sql-pipeline.png)
...
![TiDB 分散式交易兩階段提交流程](/diagrams/tidb/tidb-2pc.png)
...
![TiDB HTAP 查詢路由](/diagrams/tidb/tidb-htap-routing.png)
...
![TiDB DDL 非同步狀態機](/diagrams/tidb/tidb-ddl-states.png)
