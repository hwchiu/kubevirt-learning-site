...
├── kustomization.yaml                          # 根 overlay：產生所有 4 種資源
├── instancetypes/
│   ├── kustomization.yaml                      # 引用 cx, m, n, u, o, rt, d
│   └── {cx,d,m,n,o,rt,u}/                     # 各系列定義
├── preferences/
│   ├── kustomization.yaml                      # 引用所有 OS preference
│   └── {alpine,fedora,windows,...}/            # 各 OS preference
├── VirtualMachineClusterInstancetypes/         # 僅 Cluster Instancetype
│   └── kustomization.yaml
├── VirtualMachineClusterPreferences/           # 僅 Cluster Preference
│   └── kustomization.yaml
├── VirtualMachineInstancetypes/                # 僅 Namespace Instancetype
│   └── kustomization.yaml
└── VirtualMachinePreferences/                  # 僅 Namespace Preference
    └── kustomization.yaml
```
